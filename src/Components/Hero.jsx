...
const Hero = () => {
  ...
  return (
    <>
      <section
        className="ps-7 section-bg flex items-start gap-10 overflow-hidden"
        style={{ height: "100vh" }}
      >
        <div className="">
          <h1
            className="magic-font text-[#443C34] 
          leading-[1.2] font-bold w-125 md:text-7xl text-3xl  mt-30"
          >
            Cute
          ...
          <button
            ...
            className="bg-[#D37673]  text-white px-6 py-2  mt-5  rounded-full font-semibold shadow-lg
